...
function isOs () {
  ...
  else if ( is.iphone() ) { return 'iPhone'; }
  else if ( is.ipad() ) { return 'iPad'; }
  else if ( is.ipod() ) { return 'iPod'; }
  else if ( is.android() ) { return 'Android'; }
  else if ( is.androidPhone() ) { return 'AndroidPhone'; }
  else if ( is.windows() ) { return 'Windows'; }
  else if ( is.mac() ) { return 'Mac'; }
  else if ( is.linux() ) { return 'Linux'; }
  else { return '???'; }
}
function isType () {
  if ( is.desktop() ) { return 'Desktop'; }
  else if ( is.mobile() ) { return 'Mobile'; }
  else { return '???'; }
}
//
function uAgent() {
